...
Notice that unlike many other programs you've likely written up to this point, and just like http://cdn.cs50.net/ap/1617/problems/old_friends/old_friends.html[Old Friends], users are not entering any information **after** the program has started running. Rather, they are providing all of their input to the program at the command line, before the program has begun.
