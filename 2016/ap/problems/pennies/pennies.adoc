...
[source,bash]
----
1 x 2 x 2 x 2 x 2 x 2 x 2 x 2 x 2 x 2 x 2
...
Put more succinctly, that's 1 x 2^30^. Convert those pennies to dollars (by dividing by 100) and you get, what, over $10,000,000? On just that day? Crazy.
