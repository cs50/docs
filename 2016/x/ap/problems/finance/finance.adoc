...
You implemented the functionality to register new users, get stock quotes, and show a user's stock portfolio. Now, its time to let them "buy" and "sell" stocks, filling up (or emptying) their portfolio!
...
Submit https://forms.cs50.net/2016/x/ap/finance[this form]!
