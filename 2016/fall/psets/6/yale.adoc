...
* http://docs.cs50.net/problems/credit/credit.html[Credit], more comfortable, in a file called `credit.py`.
--
. Implement any (one) of the below exactly as specified but in Python:
+
--
* http://docs.cs50.net/problems/caesar/caesar.html[Caesar], less comfortable, in a file called `caesar.py`.
* http://docs.cs50.net/problems/vigenere/vigenere.html[Vigenère], less comfortable, in a file called `vigenere.py`.
* http://docs.cs50.net/problems/crack/crack.html[Crack], more comfortable, in a file called `crack.py`.
--
