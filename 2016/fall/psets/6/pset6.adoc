...
* Consider this problem set an opportunity not only to port your own prior work from C to Python but to improve upon those earlier implementations using lessons learned since!
