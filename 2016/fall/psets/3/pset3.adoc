...
To confirm that your code was submitted properly, visit `https://github.com/submit50/<username>`, replacing `<username>` with your own GitHub username. If you do, and you click on **Branches** you should see a branch for `find` and a branch for `fifteen`, and if you click on those branches to reveal the files within you should see your uploaded code.
