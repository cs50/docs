...
The teaching fellows will hold a course-wide review session for the quiz on Mon 11/14 from 1:00pm until 2:30pm in Sanders Theatre; it will be streamed live at https://live.cs50.net/[live.cs50.net] and be available on demand immediately afterward at https://cs50.harvard.edu/[cs50.harvard.edu]. Sections on Mon 11/14, Tue 11/15, and Wed 11/16 will also be opportunities for review. Office hours on Mon 11/14, Tue 11/15, and Wed 11/16 will be additional opportunities for Q&A.
