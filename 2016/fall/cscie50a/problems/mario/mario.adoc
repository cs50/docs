...
Navigate to your `~/workspace/week2` directory. Once there, create a new file called `mario.c` (remember how?). It's inside of that file that you'll be doing your work on this assignment.
...
----
~/workspace/week2 $ [underline]#./mario#
height: [underline]#8#
       pass:[##]
      pass:[###]
     pass:[####]
...
To submit your assignment, please do the following by *Wed 9/21 at noon*.

. Open up CS50 IDE.
. Navigate to your `~/workspace/week2` directory, ensuring that `mario.c` exists therein.
. At the terminal, type `zip first_last.zip mario.c`, replacing your own first and last name with `first` and `last` respectively. (So, for instance, `john_harvard.zip`)
...
. Head to https://www.dropbox.com/request/WEulY8BgmvLRbSX8yrNj[this link] to upload your ZIP file containing `mario.c`!
