...
after which you are free to continue exploring CS50 IDE. As of the time we're writing this specification, the current version of CS50 IDE is *62*. That's the number you should see near the top-right corner of your screen. You can always check the version number of your IDE, also, by typing `version50` in the Terminal.
