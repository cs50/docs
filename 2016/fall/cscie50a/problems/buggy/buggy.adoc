...
One more tool you may also find useful is a function called `eprintf`. Be sure to `#inlcude <cs50.h>` so you can access it in your code. Here’s David with how you could use it to debug a program:
