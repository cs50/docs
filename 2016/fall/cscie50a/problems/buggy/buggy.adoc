...
As mentioned earlier, you are not on your own when it comes to debugging these programs. Here’s David with some information a tool, debug50, that might help you as you debug these programs.
