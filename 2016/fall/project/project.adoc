...
Here are just some of the possibilities! Discuss any and all with your TF!
...
Like to make an impact on campus by building a project for the largest student-run corporation in the world? Consider tackling one of Harvard Student Agencies' http://hsa.net/cs50/hsa-track/suggested-projects[suggested project ideas] via CS50's http://hsa.net/cs50/hsa-track[HSA Track]. 

=== Hardware Track

Know that CS50 has the following hardware with which you're welcome to create amazing projects:
