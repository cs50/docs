...
== Staff Solution
Not sure how your solution should behave?
Run our example by calling '~cs50/pset1/water'. Assumed that the underlined text is what some user has typed.
[source]
----
$ [underline]#~cs50/pset1/water#
Minutes: [underline]#10#
Bottles: 120
----
...
* 'cs50.h' has a helper function `get_int()` that prompts the user to input an integer value:
+
[source, c]
----
#include <cs50.h>
