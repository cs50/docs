...
_This problem set's new this year, so we shot its walkthrough on Mon 10/24 and are still editing, but here's a rough draft so that you can   dive in whenever you'd like!_
