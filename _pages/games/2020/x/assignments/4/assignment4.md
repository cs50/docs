...
Download the distro code for your game from <https://cdn.cs50.net/games/2020/x/assignments/4/assignment4.zip> and unzip `assignment4.zip`, which should yield a directory called `assignment4`.
...
1. Using [Git](https://git-scm.com/downloads), push your work to `https://github.com/me50/USERNAME.git`, where `USERNAME` is your GitHub username, on a branch called `games50/assignments/2020/x/4` or, if you've installed [`submit50`](https://cs50.readthedocs.io/submit50/), execute
...
1. [Submit this form](https://forms.cs50.io/a28af6ca-8de9-4a7e-a634-f4ecc126e255).
