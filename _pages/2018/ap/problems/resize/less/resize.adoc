...
~cs50/chapter4/resize 4 small.bmp staff.bmp
...
[source]
----
check50 cs50/2017/ap/resize/less
----
...
Be sure that each of your files are in `~/workspace/chapter4/resize`, as with:

[source]
----
cd ~/workspace/chapter4/resize
ls
----

If any file is not in `~/workspace/chapter4/resize`, move it into that directory, as via `mv` (or via CS50 IDE's lefthand file browser).
...
----
cd ~/workspace/chapter4/resize/
submit50 cs50/2017/ap/resize/less
----
