...
Implement Huffman compression, per the below
...
within a terminal window to make sure your workspace is up-to-date. Then navigate your way to the unitB directory by executing
...
[source,bash]
----
wget http://docs.cs50.net/2018/ap/problems/huff/huff.zip
----
...
[source,bash]
----
~cs50/unitB/huff hth.txt hth.bin
----
...
You can also use help50 to help parse the `valgrind` output.

[source,bash]
----
help50 valgrind ./huff hth.bin puffed.txt
----

And don't forget to use `debug50` when debugging!
