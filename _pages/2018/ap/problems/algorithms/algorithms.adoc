...
Now for a little bit of fun. Before you actually turn in your algorithms, you probably should have someone test them out. Here's what happened in a recent iteration of CS50 making a peanut butter and jelly sandwich using an algorithm supplied by students.
