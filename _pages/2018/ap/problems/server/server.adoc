...
[source,bash]
----
wget http://docs.cs50.net/2018/ap/problems/server/server.zip
----
...
[source,bash]
----
sudo wget –O ~cs50/unitB/server http://docs.cs50.net/2016/ap/problems/server/server
...
[source,bash,subs=quotes]
----
[yellow]#Using /home/Ubuntu/workspace/unitB/public for server’s root#
