...
Let's get you started. Log into https://cs50.io/[cs50.io]
...
Be sure that each of your files are in `~/workspace/unit3/fifteen`, as with:
...
If any file is not in `~/workspace/unit3/fifteen`, move it into that directory, as via `mv` (or via CS50 IDE's lefthand file browser).
