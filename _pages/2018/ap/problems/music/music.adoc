...
to ensure you're in `~/workspace/unit4/`. Then, execute

[source]
----
wget https://cdn.cs50.net/ap/2018/problems/music/music.zip
----
...
** Be sure that `music` is in `~/workspace/unit4/music/`, as with:
+
[source]
----
cd ~/workspace/unit4/music/
ls
----
