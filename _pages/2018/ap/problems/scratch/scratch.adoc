...
Oh, and if you'd like to exhibit your project in CS50 AP's studio for 2017-18, head to https://scratch.mit.edu/studios/5268312/, then click *Add projects*, and paste in your own project's URL.
