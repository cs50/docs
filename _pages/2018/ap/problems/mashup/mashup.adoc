...
In your `unit6` execute the following:

[source,subs="macros"]
----
$ wget https://cdn.cs50.net/ap/2018/problems/mashup/mashup.zip
$ unzip mashup.zip
$ rm mashup.zip
$ cd mashup
$ ls
...
$ wget https://cdn.cs50.net/ap/2018/problems/mashup/US.zip
$ unzip US.zip
$ rm US.zip
$ ls
...
----
update50
cd ~/workspace/unit6/mashup/
submit50 cs50/2018/ap/mashup
----
