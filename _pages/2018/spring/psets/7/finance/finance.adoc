...
. *If you downloaded the problem set distribution code before Sun 3/25*, you will also need to edit `application.py` by adding the line:
+
[source]
----
import os
----
+
above the line `from cs50 import SQL` atop that file.
