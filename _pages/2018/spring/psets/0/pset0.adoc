...
[start=0]
. Attend or watch https://video.cs50.net/2017/fall/lectures/0[Week 0's lecture].
. Program in Scratch.
. Upload a file.
. Submit a form.
...
6. In the field that says "Find or create a branch...", copy/paste the following branch name exactly: `cs50/2018/spring/scratch`, and click "Create branch".
...
If you don't see results on CS50.me, make sure that your branch is named `cs50/2018/spring/scratch`. If you mistyped it the first time, you should create a new branch (repeating steps 5 and 6), making sure to name it `cs50/2018/spring/scratch`!

=== Step 2 of 2

Submit https://forms.cs50.net/2018/spring/psets/0. **If you have trouble logging in, try using your browser's "incognito" or "private" mode.**
