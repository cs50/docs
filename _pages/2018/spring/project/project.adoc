...
The proposal is your opportunity to receive approval and counsel from your teaching fellow before you proceed to design.  Submitting a proposal amounts to answering a few questions about your idea.  Once you have a project in mind, submit your proposal by filling out https://forms.cs50.io/2018/spring/proposal[the proposal form]. Even if working with one or two other classmates, **each of you** must submit the proposal form.
...
**If you have collaborated with one or two other students, each of you should submit via this same process. If your project requires (for execution and testing) hardware or software other than that offered by CS50 IDE, be sure that the TF advising you is aware of and has approved your project’s needs.**

[source]
----
update50
cd ~/workspace/project/    # or wherever you've stored your project
submit50 cs50/2018/spring/project
----

==== Step 2 of 2

Submit https://forms.cs50.io/2018/spring/implementation[]!
