...
A weekly overview of sections, subject to change, appears below. Each teaching fellow's section times are linked on the course's website. Recordings of the sections, where available, are linked below as well.
...
Office hours are opportunities for help with problem sets alongside the course's teaching fellows and course assistants. Office hours for CSCI E-50 are held online on Thursdays, Fridays, and Saturdays beginning on Thu 2/1; a link to the calendar of office hours times is available on the course's website.
