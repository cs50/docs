...
[start=0]
. Watch https://video.cs50.net/2017/fall/lectures/5[Week 4's lecture].
...
Do keep in mind the course's policy on https://docs.cs50.net/2018/x/syllabus.html#academic-honesty[academic honesty], particularly its "regret clause."
