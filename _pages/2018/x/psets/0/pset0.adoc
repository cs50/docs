...
6. In the field that says "Find or create a branch...", copy/paste the following branch name exactly: `cs50/2018/x/scratch`, and click "Create branch".
...
If you don't see results on CS50.me, make sure that your branch is named `cs50/2018/x/scratch`. If you mistyped it the first time, you should create a new branch (repeating steps 5 and 6), making sure to name it `cs50/2018/x/scratch`!
