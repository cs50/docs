...
. Watch https://video.cs50.net/2017/fall/lectures/2?t=22m47s[22m47s] through https://video.cs50.net/2017/fall/lectures/2?t=50m1s[50m1s] of Week 1's second lecture (ie, Lecture 2).
