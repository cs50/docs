...
+
--
* link:../../../../../problems/mario/less/mario.html[Mario], less comfortable, in `pset6/mario/less/mario.py`
* link:../../../../../problems/mario/more/mario.html[Mario], more comfortable, in `pset6/mario/more/mario.py`
--
+
. Implement either of the below exactly as specified but in Python:
+
