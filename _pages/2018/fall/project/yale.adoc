...
```
submit50 cs50/2018/fall/project/preproposal
```
...
The proposal is your opportunity to receive approval and counsel from your teaching assistant before you proceed to design. If collaborating with one or two classmates, each of you should submit a proposal, even if identical.
...
```
submit50 cs50/2018/fall/project/proposal
```
...
Not only is the status report intended to keep the staff apprised of your progress, it is an opportunity to keep yourself on track. If collaborating with one or two classmates, each of you should submit a proposal, even if identical.
