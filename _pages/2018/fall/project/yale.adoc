...
Here are just some of the possibilities, organized into (non-exhaustive) "tracks". Discuss any and all with your TA! And if you'd like to solicit             collaborators for an idea you have, do post to https://discourse.cs50.net/c/cs50-2018-fall[Discourse]!
...
_due by Tue 11/6, 11:59pm_

Intended to promote early thought, the preproposal is your opportunity to bounce one or more ideas off of your teaching assistant.

Here's how to submit your preproposal. Log into link:https://cs50.io/[CS50 IDE] and then, in a terminal window:
...
Then execute the below from within your `~/workspace/project/preproposal` directory, logging in with your GitHub username and password when prompted. For     security, you'll see asterisks (`*`) instead of the actual characters in your password.

```
submit50 cs50/2018/fall/preproposal
```

=== Proposal

_due by Tue 11/13, 11:59pm_

The proposal is your opportunity to receive approval and counsel from your teaching assistant before you proceed to design. If collaborating with 1, 2, or 3 classmates, each of you should submit a proposal, even if identical.

Your teaching assistant will either approve your proposal or require modifications on your part for subsequent approval.  Your proposal, even if approved, is not binding; you may alter your plan at any point, provided you obtain your teaching assistant's approval for any modifications.  Projects submitted without approval may not receive credit.
...
Here's how to submit your proposal. Log into link:https://cs50.io/[CS50 IDE] and then, in a terminal window:
...
Then execute the below from within your `~/workspace/project/proposal` directory, logging in with your GitHub username and password when prompted. For        security, you'll see asterisks (`*`) instead of the actual characters in your password.

```
submit50 cs50/2018/fall/proposal
```
...
Not only is the status report intended to keep the staff apprised of your progress, it is an opportunity to keep yourself on track. If collaborating with 1, 2, or 3 classmates, each of you should submit a proposal, even if identical.
...
```
submit50 cs50/2018/fall/status
```
...
submit50 cs50/2018/fall/implementation
----

=== Step 2 of 2

Submit https://forms.cs50.io/2018/fall/project/implementation[]!
...
The CS50 Fair will take place in Sterling Memorial Library and the Center for Teaching and Learning.
