...
If, incidentally, you have an idea for a final project that you think someone should do (if not you), post it https://discourse.cs50.net/c/cs50-2018-fall[Discourse]!  And if you'd like to solicit one or two collaborators, do post there as well.
