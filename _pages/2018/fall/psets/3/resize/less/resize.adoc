...
Here's how to download this problem's "distribution code" (i.e., starter code) into your own CS50 IDE.
...
1. Execute `wget http://cdn.cs50.net/2018/fall/psets/3/resize.zip` to download a (compressed) ZIP file with this problem's distribution.
