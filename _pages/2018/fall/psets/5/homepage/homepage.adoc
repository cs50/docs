...
And if you'd like to publish your site publicly so that your classmates, friends, and anyone who knows your GitHub username can visit your page on the web, execute the below:
