...
[source,subs="macros"]
----
$ wget http://cdn.cs50.net/2018/fall/psets/6/similarities/similarities.zip
...
See http://cdn.cs50.net/2018/fall/psets/6/similarities/inputs/ for sample inputs, though be sure to test with some of your own!
