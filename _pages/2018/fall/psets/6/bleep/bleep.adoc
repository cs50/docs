...
* You should not censor words that merely contain a banned word as a substring. For example, **bar** is a banned word in the provided `banned.txt`, but neither __**bar**ns__ nor __crow**bar**__ nor __wheel**bar**row__ should be censored.
