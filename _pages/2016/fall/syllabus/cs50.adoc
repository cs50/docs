...
Due by noon on Thu 11/17 is a take-home quiz that will cover Weeks 0 through 10 (and Problem Sets 0 through 8), with emphasis on Week 7 (and Problem Set 6) onward. The quiz is open-book: you may use any and all resources during the test, but the only humans to whom you may turn for help or from whom you may receive help are the course's heads.
