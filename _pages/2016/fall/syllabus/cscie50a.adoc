...
|===
2+| Lecture | Released
| Week 0 | Computers and computing. Hardware. Memory. Binary. ASCII. Algorithms. | Wed 8/31, Fri 9/2
| Week 1 | Pseudocode. Scratch. Syntax. Statements. | Tue 9/6, Fri 9/9
| Week 2 | Variables. Data types. Loops. | Tue 9/13, Fri 9/16
| Week 3 | Conditionals. Compiling. Source code. Object code. | Tue 9/20, Fri 9/23
| Week 4 | Functions. Arrays. Strings. | Tue 9/27, Fri 9/30
...
Integrated into course's problems are "walkthroughs," videos via which the course's staff offer direction on where to begin and how to approach a challenge. You are expected to watch walkthroughs before asking questions about problem sets at office hours or via https://cs50.harvard.edu/discuss[CS50 Discuss].
...
| Everyday Algorithms | Written | Fri 9/2 | Wed 9/7
| Scratch | Programming | Tue 9/6 | Sat 9/10
| Hello | Programming | Fri 9/9 | Wed 9/14
| Fahrenheit | Programming | Tue 9/13 | Sat 9/17
| Mario | Programming | Fri 9/16 | Wed 9/21
| Greedy | Programming | Tue 9/20 | Sat 9/24
| Me, Myself, and UI | Written | Fri 9/23 | Wed 9/28
| ISBN | Programming | Tue 9/27 | Sat 10/1
