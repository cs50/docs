...
* Your project should be more complex than most of those demonstrated in lecture (many of which, though instructive, were quite short) but it can be less complex than _Oscartime_, _Pokemon Go_, and _Ivy's Hardest Game_. As such, your project should probably use a few dozen puzzle pieces overall.
...
Oh, and if you'd like to exhibit your project in Fall 2016's studio, head to https://scratch.mit.edu/studios/3003963/, then click *Add projects*, and paste in your own project's URL.

== How to Submit

_Coming Fri 9/2. Reload this page then!_
