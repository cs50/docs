...
To submit your writing assignment, give it the name *Last,First-AnalyzeThis*, substituting *Last* and *First* with your own last and first names, respectively. So, if your name were __John Harvard__, your file would be named *Harvard,John-AnalyzeThis*. You can upload this writing assignment as either a Word document (`.doc`), PDF file (`.pdf`), or text file (`.rtf`, `.txt`).

Then, visit https://www.dropbox.com/request/LmC5itoVC7ppHHgYA9tL[this link] and upload your file to our Dropbox folder. Remember that the deadline for this assignment is Wednesday, November 23 at noon Eastern time. If you wish to resubmit your assignment, know that you can do so as many times as you'd like. We will grade your latest submission that was received prior to the deadline.
