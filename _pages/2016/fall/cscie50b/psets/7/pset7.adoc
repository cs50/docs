...
Don't omit those periods at the end of the third and fourth commands above, so that CS50 IDE's web server (Apache) and you (from a browser) will be able to access your work.  Then, navigate your way to `~/workspace/pset7/public` by executing the below.
...
you should see that `public` contains four subdirectories and three files.  
