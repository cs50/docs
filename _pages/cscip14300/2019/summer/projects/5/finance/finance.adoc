...
Log into CS50 IDE at https://ide.cs50.io/[ide.cs50.io] and then execute each of the commands below (without the leading dollar sign) in a terminal window.

[source,subs="macros"]
----
$ wget http://cdn.cs50.net/cscip14300/2019/projects/5/finance.zip
$ unzip finance.zip
$ rm finance.zip
$ cd finance
$ ls
