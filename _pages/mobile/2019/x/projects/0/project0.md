...
1. Using Git, push your work to `https://github.com/submit50/USERNAME.git`, where `USERNAME` is your GitHub username, on a branch called `cs50/mobile/2019/x/projects/0` or, if you've installed `submit50`, execute

   ```
   submit50 cs50/mobile/2019/x/projects/0
   ```
