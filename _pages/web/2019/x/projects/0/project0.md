...
Download the distro code for this project from <https://cdn.cs50.net/web/2019/spring/projects/0/project0.zip> and unzip `project0.zip`, which should yield a directory called `project0`.
