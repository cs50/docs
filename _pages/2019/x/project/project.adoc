...
Create a `README.md` text file that explains your project and save it in a new folder called `project` in your `~/workspace` directory. 
...
```
Note that your project source code itself should not be submitted, so if you already have a folder called `project` for that code, feel free to create a new folder to hold your `README.md` file and run the above `submit50` command there instead.
