...
1. Execute `wget https://cdn.cs50.net/2018/fall/psets/4/speller/hashtable/speller.zip` to download a (compressed) ZIP file with this problem's distribution.
...
[source]
----
check50 cs50/2019/x/challenges/speller
----
