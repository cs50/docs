...
* Write, in a file called `mario.py` in `~/workspace/pset6/mario/more/`, a program that recreates these half-pyramids using hashes (`#`) for blocks, exactly as you did in link:https://lab.cs50.io/cs50/labs/2019/x/mario/more/[Problem Set 1], except that your program this time should be written (a) in Python and (b) in CS50 IDE.
...
[source]
----
check50 cs50/2019/x/sentimental/mario/more
----
...
[source]
----
~cs50/2019/x/pset6/mario/more/mario
----
...
```
submit50 cs50/2019/x/sentimental/mario/more
```
