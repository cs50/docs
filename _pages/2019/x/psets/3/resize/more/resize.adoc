...
1. Execute `wget https://cdn.cs50.net/2018/fall/psets/3/resize/more/resize.zip` to download a (compressed) ZIP file with this problem's distribution.
...
[source]
----
~cs50/2019/x/hacker3/peek large.bmp
----
...
~cs50/2019/x/hacker3/resize 4 small.bmp staff.bmp
~cs50/2019/x/hacker3/peek student.bmp staff.bmp
----
...
[source]
----
check50 cs50/2019/x/resize/more
----
...
```
submit50 cs50/2019/x/resize/more
```
