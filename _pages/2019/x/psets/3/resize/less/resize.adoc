...
1. Execute `wget https://cdn.cs50.net/2018/fall/psets/3/resize/less/resize.zip` to download a (compressed) ZIP file with this problem's distribution.
...
[source]
----
~cs50/problems/2019/x/pset3/peek large.bmp
----
...
~cs50/problems/2019/x/pset3/resize 4 small.bmp staff.bmp
~cs50/problems/2019/x/pset3/peek student.bmp staff.bmp
----
