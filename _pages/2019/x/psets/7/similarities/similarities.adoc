...
1. Execute `wget https://cdn.cs50.net/2018/fall/psets/7/similarities/similarities.zip` to download a (compressed) ZIP file with this problem's distribution.
...
Be sure to test your implementation with the files in `inputs/` (which are also available  https://cdn.cs50.net/2018/fall/psets/7/similarities/similarities/inputs/[via a browser]) as well as with some files of your own!

=== `check50`

```
check50 cs50/2019/x/similarities
```
...
```
submit50 cs50/2019/x/similarities
```
