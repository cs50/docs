...
1. Execute `wget http://cdn.cs50.net/2019/x/psets/7/similarities/similarities.zip` to download a (compressed) ZIP file with this problem's distribution.
...
$ mkdir pset7
$ cd pset7
$ wget http://cdn.cs50.net/2019/x/psets/7/similarities/similarities.zip
...
Be sure to test your implementation with the files in `inputs/` (which also available link: http://cdn.cs50.net/2019/x/psets/7/similarities/similarities/inputs/[via a browser]) as well as with some files of your own!
