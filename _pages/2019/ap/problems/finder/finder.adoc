...
As usual, after logging into https://ide.cs50.io[ide.cs50.io].Next, execute
...
at your prompt to ensure that you're inside of `unit4`. Then execute

[source,bash]
----
wget https://cdn.cs50.net/ap/2019/problems/finder/finder.zip
----
...
[source]
----
check50 cs50/problems/2019/ap/finder
----
...
Be sure that each of your files are in `~/unit4/finder`, as with:
...
If any file is not in `~/unit4/finder`, move it into that directory, as via `mv` (or via CS50 IDE's lefthand file browser).
...
----
cd ~/unit4/finder
submit50 cs50/problems/2019/ap/finder
----
