...
Next, navigate to your `~/chapter3` directory.  Then execute
...
you should see that you now have a file called `whodunit.zip` in your `~/chapter3` directory.  Unzip it by executing the below.
