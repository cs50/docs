...
Navigate to your `unitA` directory and execute the following:

[source,bash]
----
wget http://docs.cs50.net/2019/ap/problems/autocomplete/autocomplete.zip
----
...
----
~/unitA/autocomplete/ $ [underline]#./autocomplete large.txt help#
help
helped
helper
helpers
