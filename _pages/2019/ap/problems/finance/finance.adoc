...
Be sure that each of your files are in `~/chapter7/fifteen`, as with:
...
If any file is not in `~/chapter7/finance`, move it into that directory, as via `mv` (or via CS50 IDE's lefthand file browser).
