...
Start off by opening up CS50 IDE. Next, navigate to your `unit2` directory, as with
...
Keep in mind that `~/` denotes your home directory, and `~/unit2` denotes a directory called `unit2` within your home directory. Your prompt should now resemble the below.
...
[source,subs=quotes]
----
~/unit2/friends $ [underline]#./hello Zamyla#
hello, Zamyla
----
...
[source,bash]
----
check50 cs50/2019/ap/friends/hello
----
...
In https://docs.cs50.net/2019/ap/problems/fahrenheit/fahrenheit.html[Fahrenheit] you were asked to write a program that asked the user for a temperature in Celsius (which they provided via `get_float`) and which then printed out the equivalent temperature on the Fahrenheit scale.

[source,subs=quotes]
----
~/unit2/friends $ [underline]#./fahrenheit#
C: [underline]#0#
F: 32.0
----
...
[source,subs=quotes]
----
~/unit2/friends $ [underline]#./fahrenheit 0#
F: 32.0
----
...
[source,bash]
----
check50 cs50/2019/ap/friends/fahrenheit
----
...
In https://docs.cs50.net/2019/ap/problems/pennies/pennies.html[Pennies] you were asked to write a program that demonstrated the power of exponentiation by showing how much money you would have if a person gave you __x__ pennies on a particular day, and then doubled the amount they gave you every day for a period of __y__ days.

[source,subs=quotes]
----
~/unit2/friends $ [underline]#./pennies#
...
[source,subs=quotes]
----
~/unit2/friends $ [underline]#./pennies 31 1#
$21474836.47
----
...
[source,bash]
----
check50 cs50/2019/ap/friends/pennies
----
...
Be sure that each of your files is in `~/unit2/friends`, as with:
...
If any file is not in `~/unit2/friends`, move it into that directory, as via `mv` (or via CS50 IDE's lefthand file browser).
...
----
cd ~/unit2/friends
submit50 cs50/2019/ap/friends/hello
----
+
...
----
cd ~/unit2/friends
submit50 cs50/2019/ap/friends/fahrenheit
----
+
inputting your GitHub username and GitHub password as prompted.
...
----
cd ~/unit2/friends
submit50 cs50/2019/ap/friends/pennies
----
+
inputting your GitHub username and GitHub password as prompted.
