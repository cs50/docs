...
Keep in mind that `~` denotes your home directory, and `~/chapter2` denotes a directory called `chapter2` within your home directory. Your prompt should now resemble the below.
