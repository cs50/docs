...
First, log into https://ide.cs50.io/[ide.cs50.io]. Then, create a new directory called `unit4` (Remember how?) and navigate inside. Once there, obtain a copy of this problem's distro by typing:

[source,bash]
----
wget https://cdn.cs50.net/ap/2019/problems/sudoku/sudoku.zip
----

Unzip the ZIP file (remember how?) and then delete the ZIP file from your `unit4` directory. Navigate into your newly-created `sudoku` directory and type:
...
* https://en.wikipedia.org/wiki/Algorithmics_of_Sudoku
...
Navigate to your `~/unit4/sudoku` directory and execute the increasingly familiar command below:
...
Before you do, though, a few questions for you. Create a file called `questions.txt` in `~/workspace/unit4/sudoku` and record in it your answers to the below:
...
And you might wish that your Sudoku game was more like https://xkcd.com/74/[this]. But you'll have created a pretty darn impressive game, that hopefully your family and friends will enjoy.
...
** Be sure that the following files exist in `~/unit4/sudoku/`:
* `Makefile`  
* `sudoku.c`  
* `sudoku.h` 
as with:
...
----
cd ~/unit4/sudoku/
submit50 cs50/problems/2019/ap/sudoku
----
