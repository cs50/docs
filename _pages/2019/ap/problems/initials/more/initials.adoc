...
[source,text]
----
check50 cs50/2018/ap/initials/more
----
...
** Be sure that `initials.c` is in `~/workspace/unit2/initials/`, as with:
+
[source]
----
cd ~/workspace/unit2/initials/
ls
----
...
----
cd ~/workspace/unit2/initials/
submit50 cs50/2018/ap/initials/more
----
+
