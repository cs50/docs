...
Design and implement a program, `caesar`, that encrypts messages using Caesar's cipher, exactly as you did in link:https://lab.cs50.io/cs50/labs/2019/ap/caesar/[Problem Set 2], except that your program this time should be written (a) in Python and (b) in CS50 IDE.
...
Head back to the https://ide.cs50.io[CS50 IDE] and ensure that `caesar.py` is in `~/chapter6/caesar`, as with:
