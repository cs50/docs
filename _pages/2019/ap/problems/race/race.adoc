...
First, refresh your memory on the __O(n^2^)__ sorting algorithms we've learned about so far in the course. Here's Doug to explain:
...
As always, first log into your CS50 IDE at https://ide.cs50.io/[ide.cs50.io]. Next, execute
...
[source,bash]
----
wget https://cdn.cs50.net/ap/2019/problems/race/race.zip
----

to download a ZIP of this problem's distro into your `unit3` directory. You should see a bunch of output followed by:
...
[source,subs=quotes]
----
~/unit3/race/ $ [underline]#./race -b 2000#
...
[source,subs=quotes]
----
~/unit3/race/ $ [underline]#./race -r 100000#
...
[source,subs=quotes]
----
~/unit3/race/ $ [underline]#./race -s 20000#
bubble sort benchmark:         0.000 seconds
...
** Be sure that the following files exist in `~/unit3/race/`:
* `Makefile`  
* `helpers.c`  
* `helpers.h`
* `race.o` 
...
----
cd ~/unit3/race/
submit50 cs50/problems/2019/ap/race
----
