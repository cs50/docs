...
In this problem, you will be tasked with implementing a not so simple command-line based calculator program. (Hmm... http://docs.cs50.net/2019/ap/problems/calc/calc.html[that sounds familiar].) Your program will accept inputs like this (wherein underlined text represents user input):

[source,subs=quotes]
----
~/chapterA/ $ [underline]#./calc2 + - 3 4 5#
4.000000
----
...
[source,subs=quotes]
----
username@ide50:~/chapterA/ $ [underline]#./calc2 x - 3.4 5.6 7.9#
-17.3799999
----
