...
Start off by opening up CS50 IDE and navigate to your `unitA` directory. Once there, execute the following:

[source,bash]
----
wget https://docs.cs50.net/2019/ap/problems/leaky/leaky.zip
----
