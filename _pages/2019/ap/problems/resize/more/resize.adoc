...
1. Execute `wget http://cdn.cs50.net/ap/2019/problems/resize/more/resize.zip` to download a (compressed) ZIP file with this problem's distribution.
...
1. Execute `ls`. You should see this problem's distribution code, including `bmp.h`, `copy.c`, `large.bmp`, `small.bmp`, and `smiley.bmp`.
...
* Implement your program in a file called `resize.c` inside of `~/chapter3/resize/more/`.
...
[source]
----
~cs50/2019/ap/chapter3/resize/less/peek large.bmp
----
...
~cs50/2019/ap/chapter3/resize/more/resize 4 small.bmp staff.bmp
~cs50/2019/ap/chapter3/resize/more/peek student.bmp staff.bmp
----
...
Head back to the ide.cs50.io[CS50 IDE] and ensure that `resize.c` is in `~/chapter3/resize/more`, as with:

[source]
----
cd ~/chapter3/resize/more
ls
----

If `resize.c` is not in `~/chapter3/resize/more`, move it into that directory, as via `mv` (or via CS50 IDE's lefthand file browser).
...
----
cd ~/chapter3/resize/more
submit50 cs50/problems/2019/ap/resize/more
----
+
