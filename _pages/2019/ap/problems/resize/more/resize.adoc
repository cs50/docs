...
1. Execute `wget http://cdn.cs50.net/2019/ap/chapters/3/resize/more/resize.zip` to download a (compressed) ZIP file with this problem's distribution.
...
* Implement your program in a file called `resize.c` inside of `~/chapter3/more/`.
