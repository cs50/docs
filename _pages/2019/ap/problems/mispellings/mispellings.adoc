...
Log into https://ide.cs50.io/[CS50 IDE] and navigate to the location in your IDE where you are writing code for unit A and execute the below:

[source,bash]
----
wget http://docs.cs50.net/2019/ap/problems/mispellings/mispellings.zip
----
