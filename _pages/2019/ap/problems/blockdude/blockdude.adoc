...
First, log into ide.cs50.io, then create a new directory called `unitB` (Remember how?) and navigate inside. Once there, obtain a copy of this problem's distro by typing:

[source,bash]
----
wget https://docs.cs50.net/2019/ap/problems/blockdude/blockdude.zip
----
...
Navigate to your `~/unitB/distro` directory and execute the increasingly familiar command below:
