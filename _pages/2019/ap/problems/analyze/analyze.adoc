...
Go to https://github.com/me50/USERNAME, substituting `USERNAME` in the URL with your own GitHub username. On the left side of the screen, click on "Branch: master". In the field that says "Find or create a branch...", type `cs50/problems/2019/ap/analyze` and click "Create branch".

=== Step 2 of 3

Click the button that says "Upload files". Drag your `analyze.(doc, docx, pdf, txt)` file into the box that says "Drag files here".
