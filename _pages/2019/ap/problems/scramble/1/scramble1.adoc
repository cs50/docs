...
First, log into https://ide.cs50.io/[ide.cs50.io]. Then, execute
...
[source,bash]
----
wget https://cdn.cs50.net/ap/2019/problems/scramble/scramble.zip
----
...
[source]
----
check50 cs50/problems/2019/ap/scramble/1
----
...
Be sure that `scramble.c` is in `~/unit3/scramble`, as with:
...
If `scramble.c` is not in `~/unit3/scramble`, move it into that directory, as via `mv` (or via CS50 IDE's lefthand file browser).
...
----
cd ~/unit3/scramble/
submit50 cs50/problems/2019/ap/scramble/1
----
