...
Python. Flask. SQL. MVC. JavaScript. Ajax. Artificial Intelligence. Virtual and Augmented Reality.
...
All problems are due on April 30, 2018. You will receive a certificate of completion, if a satisfactory grade (60%) is earned on all problems.
