...
Below are frequently asked questions (FAQs) specific to CS50x AP 2017. For questions specific to edX, see https://support.edx.org/[support.edx.org].
...
Only one, when the course itself ends! You are welcome to take CS50 AP at your own pace, so long as you submit all problems no later than 30 April 2018.
...
Nope, even if this is your first time here, you're not too late to begin! You are welcome to take CS50 AP at your own pace, starting whenever you'd like, so long as you finish before 30 April 2018.

== What does edX's Verified Certificate of Achievement look like?

Odds are 2017's will resemble https://www.edx.org/sites/default/files/theme/example-certificate-verified.png[this sample].
