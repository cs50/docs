...
In your `chapter6` directory, execute the following: 

[source,subs="macros"]
----
$ wget http://docs.cs50.net/2017/ap/problems/finance/finance.zip
$ unzip finance.zip
$ rm finance.zip
$ cd finance
$ ls
...
[source]
----
cd ~/workspace/chapter6/finance/
submit50 cs50/2017/ap/finance
----
