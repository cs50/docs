...
[source,bash]
----
wget http://docs.cs50.net/2017/ap/problems/whodunit/whodunit.zip
----
...
Be sure that each of your files are in `~/workspace/chapter4/whodunit`, as with:
...
If any file is not in `~/workspace/chapter4/whodunit`, move it into that directory, as via `mv` (or via CS50 IDE's lefthand file browser).
...
----
cd ~/workspace/chapter4/whodunit/
submit50 cs50/2017/ap/whodunit
----
