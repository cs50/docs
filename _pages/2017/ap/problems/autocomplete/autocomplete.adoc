...
[source,bash]
----
wget http://docs.cs50.net/2017/ap/problems/autocomplete/autocomplete.zip
----
...
----
~/workspace/chapterA/autocomplete/ $ [underline]#./autocomplete large.txt help#
help
helped
helper
helpers
...
[source]
----
check50 cs50/2017/ap/autocomplete
----

And if you want to play with the staff's solution, it's available at
