...
[source,bash]
----
wget http://docs.cs50.net/2017/ap/problems/scramble/scramble.zip
----
...
[source]
----
check50 cs50/2017/ap/scramble/1
----
...
Ensure `scramble.c` is in your chapter 3 directory


Be sure that each of your files are in `~/workspace/chapter3/scramble`, as with:

[source]
----
cd ~/workspace/chapter3/scramble
ls
----

If `scramble.c` is not in `~/workspace/chapter3/scramble`, move it into that directory, as via `mv` (or via CS50 IDE's lefthand file browser).
...
----
cd ~/workspace/chapter3/scramble/
submit50 cs50/2017/ap/scramble/1
----
