...
Run the following code in your `~/workspace/chapter6` directory to get started!
...
. Click *Select or create project*, click *+Create a new project*, and input *mashup* (or anything else) under *Enter new project name*.
