...
In your `chapter6` execute the following:

[source,subs="macros"]
----
$ wget http://docs.cs50.net/2017/ap/problems/mashup/mashup.zip
$ unzip mashup.zip
$ rm mashup.zip
$ cd mashup
$ ls
...
$ wget http://docs.cs50.net/2017/ap/problems/mashup/US.zip
$ unzip US.zip
$ rm US.zip
$ ls
...
No `check50`! Be sure to try to "break" your own site, as by
...
----
update50
cd ~/workspace/chapter6/mashup/
submit50 cs50/2017/ap/mashup
----
