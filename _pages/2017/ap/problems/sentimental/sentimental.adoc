...
+
--
* link:../mario/less/mario.html[Mario], less comfortable, in a file called `mario.py` in `chapter6/`.
* link:../mario/more/mario.html[Mario], more comfortable, in a file called `mario.py` in `chapter6/`.
--
+
...
+
--
* link:../greedy/greedy.html[Greedy], in a file called `greedy.py` in `chapter6/`.
* link:../caesar/caesar.html[Caesar], in a file called `caesar.py` in `chapter6/`.
--
