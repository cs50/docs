...
[source, subs=quotes]
----
$ [underline]#./scale .5 large.bmp small.bmp#
----
...
[source,bash]
----
./shrink 4.0 small.bmp large.bmp
----
...
[source,bash]
----
check50 1718.chapter4.shrink bmp.h shrink.c
----
