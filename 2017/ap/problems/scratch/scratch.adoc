...
Build a cool project in Scratch.
...
* Watch https://youtu.be/tveoFN0NHE0[David's brief tour].
...
In fact, for a gentler introduction to Scratch (and programming more generally), you might want to review some of the examples at https://scratch.mit.edu/studios/3003963/. Once you can say to yourself, "Okay, I think I get this," you're ready to proceed.
...
Oh, and if you'd like to exhibit your project in CS50 AP's studio for 2017-18, head to https://scratch.mit.edu/studios/4107376/, then click *Add projects*, and paste in your own project's URL.
...
4. Go to https://github.com/submit50/USERNAME, substituting `USERNAME` in the URL with your own GitHub username.
5. On the left side of the screen, click on "Branch: master".
6. In the field that says "Find or create a branch...", type `cs50/2017/ap/scratch` and click "Create branch".
