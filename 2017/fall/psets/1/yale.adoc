...
[start=0]
. Watch https://video.cs50.net/2017/fall/lectures/1[Week 1's lecture].
...
submit50 2017/cs50/fall/mario/less
----
...
submit50 2017/cs50/fall/mario/more
----
--

=== Step 2 of 2

Head to https://forms.cs50.net/2017/fall/psets/1 where a short form will await **starting Thu 9/7 evening**. Once you have submitted that form (as well as your source code), you are done! If you end up resubmitting your files (per step 1 of 2), no need to resubmit the form.
