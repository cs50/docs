...
Included with this problem is "distribution code," code that we've written that you'll first need to read (and understand!) before contributing improvements of your own.
...
And here's how to read through it!
