...
3. On your Scratch editor page (e.g. https://scratch.mit.edu/projects/123456789/#editor), go to the "File" menu and click "Download to your computer". Make sure to save the file as `project.sb2` (case sensitive). Make sure the filename is exactly `project.sb2`, otherwise CS50.me won't be able to recognize your submission!
