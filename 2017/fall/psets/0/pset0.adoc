...
1. Submit https://forms.cs50.net/2017/fall/psets/0. 
2. Visit https://cs50.me[CS50.me], log in with your GitHub account, and click *Authorize application*.
3. You should receive two emails from GitHub inviting you to join CS50's GitHub organizations. Click the button to accept both of these invitations.
4. On your Scratch project page, go to the "File" menu and click "Download to your computer". Make sure to save the file as `project.sb2` (case sensitive).
5. Go to https://github.com/submit50/USERNAME, replacing `USERNAME` in the URL with your own GitHub username.
6. On the left side of the screen, click on "Branch: master".
7. In the field that says "Find or create a branch...", type `cs50/2017/fall/scratch` and click "Create branch".
...
11. You're done! If you go back to https://cs50.me[CS50.me], you should see your Scratch submission. If you click on the **check50** link next to the submission, you should see (after a minute or two) whether your project met all of the requirements. You are welcome to resubmit as many times as you'd like (before the deadline)!
