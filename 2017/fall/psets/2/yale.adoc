...
[start=0]
. Watch https://video.cs50.net/2017/fall/lectures/2[Week 2's lecture].
...
----
+
You're welcome but not expected to submit all three; if you do, we'll grade your two best.
--
