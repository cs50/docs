...
Nine problem sets are assigned during the semester. Late work is not ordinarily accepted, except with a Dean's excuse.  (Graduate students should e-mail heads@cs50 as early as possible to request an extension.)
