...
+
image::valgrind_1.png[alt="Valgrind output", width=500]
+
image::valgrind_2.png[alt="Valgrind output", width=500]
...
+
image::help50.png[alt="help50 valgrind output", width=500]
...
+
image::help50_2.png[alt="help50 valgrind output", width=500]
