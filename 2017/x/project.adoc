...
If at a loss for ideas, turn to https://manual.cs50.net/seminars/[CS50's seminars] for inspiration!
...
When ready to submit your video, submit https://newforms.cs50.net/2017/x/project[this form]!
...
Shortly after 31 December 2017, we'll create a website where you'll be able to explore classmates' projects anytime, anywhere. We'll let you know when the epic display is ready!
