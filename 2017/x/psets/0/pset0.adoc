...
If you don't see a "Branch: master" button upon going to your submit50 page on GitHub, try clicking the "README" button next to "We recommend every repository include a..." and then clicking the green "Commit new file" button. After that, the "Branch: master" button should appear!
