...
pip3 install --user -r --upgrade requirements.txt
----
+
...
* https://twitter.com/CNN[@CNN]
* https://twitter.com/nytimes[@nytimes]
* https://twitter.com/FoxNews[@FoxNews]
...
* 2017-03-03
** Updated sample Twitter account list
* 2016-10-27
