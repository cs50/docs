...
_due by noon on Fri 4/7_

=== Proposal

_due by noon on Fri 4/14_

=== Status Report

_due by noon on Mon 5/1_

=== Implementation

_due by noon on Thu 5/11_

=== CS50 Fair

_from 5:30pm until 7pm on Fri 5/12_
...
The proposal is your opportunity to receive approval and counsel from your teaching fellow before you proceed to design.  Submitting a proposal amounts to answering a few questions about your idea.  Once you have a project in mind, submit your proposal at forms.cs50.net/2017/spring/proposal[this link]. If working with one or two other classmates, it suffices for just one of you to submit the proposal.
...
Not only is the status report intended to keep the staff apprised of your progress, it is an opportunity to keep yourself on track.  Submitting a status report amounts to answering a few questions about your project.  Your answers will also influence the setup of the CS50 Fair.  Submit your status report at COMING SOON. All team members must submit the status report individually.

=== Implementation

Ultimately due are implementation and documentation of your final project. All team members must submit the implementation individually. Your submission thereof must include all of the below.
...
submit50 e50b/2017/spring/project
----

=== Step 2 of 2

Complete the form at https://forms.cs50.net/2017/spring/implementation[].
...
The CS50 Fair will take place in the CS50 office.
